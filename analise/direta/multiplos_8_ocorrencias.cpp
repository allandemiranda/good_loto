/**
 * @brief Programa para gerar analise em cima dos núemros Multiplos de 8 - Ocorências
 * 
 * @file multiplos_8_ocorrencias.cpp
...
// A cada 2 jogo, saem {1, 2, 3, 4, 5, 6} números multiplos
// A cada 3 jogo, saem {2, 3, 4, 5, 6, 7, 8} números multiplos
// A cada 5 jogo, saem {5, 6, 7, 8, 9, 10, 11, 12} números multiplos
