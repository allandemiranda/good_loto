/**
 * @brief Programa para gerar analise em cima dos núemros Multiplos de 6 - Ocorências
 * 
 * @file multiplos_6_ocorrencias.cpp
...
// A cada 1 jogo, saem {1, 2, 3, 4} números multiplos de 6 ***
// A cada 2 jogo, saem {2, 3, 4, 5, 6, 7} números multiplos de 6
// A cada 3 jogo, saem {4, 5, 6, 7, 8, 9, 10} números multiplos de 6
// A cada 5 jogo, saem {8, 9, 10, 11, 12, 13, 14, 15} números multiplos de 6
