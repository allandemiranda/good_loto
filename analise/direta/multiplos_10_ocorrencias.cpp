/**
 * @brief Programa para gerar analise em cima dos núemros Multiplos de 10 - Ocorências
 * 
 * @file multiplos_10_ocorrencias.cpp
...
// A cada 8 jogo, saem {5, 6, 7, 8, 9, 10, 11, 12, 13} números multiplos
