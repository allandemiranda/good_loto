/**
 * @brief Programa para gerar analise em cima dos núemros de PAres - Binário
 * 
 * @file pares_binario.cpp
...
// ### REGRA PARA BINÁRIO ###
// Com 1 jogos, existem somente 1277 padrões
// Com 2 jogos, existem somente 258 padrões
// Com 3 jogos, existem somente 66 padrões
// Com 5 jogos, existem somente 12 padrões
// Com 2 jogos ou mais, todos os números são sorteados
...
int main(int argc, char *argv[ ]){
    ...
    std::vector <size_t> ocorrencias; // Quantidade de ocorrencias por jogo
