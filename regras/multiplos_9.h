...
bool multiplos_9_soma(int *inicial){
    bool bandeira;
    int numeros_p_analise[] = {9,18}; // números da cartela
    int soma(0);
    ...
    if((quantidade_de_jogos_sorteados+analise_padrao-1)%analise_padrao == 0){
        ...
        int numeros_verdade_dois[] = {18, 27, 36, 45, 54, 63, 72, 81};
    ...
    if((quantidade_de_jogos_sorteados+analise_padrao-1)%analise_padrao == 0){
        ...
        int numeros_verdade_dois[] = {45, 54, 63, 72, 81, 90, 99, 108, 117};
        for(int *i=std::begin(numeros_verdade_dois); i<std::end(numeros_verdade_dois); ++i){
            if(*i == (soma_analise_padrao + soma)){
                bandeira = false;
                break;
...
bool multiplos_9_ocorrencias(int *inicial){
    // primeiro definição
    int numeros_p_analise[] = {9,18}; // números  da cartela
    int cont(0);
    ...
    if((quantidade_de_jogos_sorteados+analise_padrao-1)%analise_padrao == 0){
        ...
        if(((cont + cont_analise_padrao) < 2) or ((cont + cont_analise_padrao) > 4)){        
            return false;
        }
    }
...
bool multiplos_9_binario(int *inicial){
    int tamanho_amostra;
    int numeros_p_analise[] = {9,18}; // números da cartela
