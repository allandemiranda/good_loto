...
bool multiplos_11_soma(int *inicial){
    bool bandeira;
    ...
    if((quantidade_de_jogos_sorteados+analise_padrao-1)%analise_padrao == 0){
        ...
        int numeros_verdade_dois[] = {11, 22, 33, 44, 55, 66, 77, 88, 99};
...
bool multiplos_11_ocorrencias(int *inicial){
    // primeiro definição
    int numeros_p_analise[] = {11,22}; // números  da cartela
    int cont(0);
...
bool multiplos_11_binario(int *inicial){
    int tamanho_amostra;
    int numeros_p_analise[] = {11,22}; // números da cartela
