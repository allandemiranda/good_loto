/**
 * @brief Regras geradas pela analise dos númros multilos de 7
 * 
 * @file multiplos_7.h
...
/**
 * @brief Função que verifica somente todas as regras multiplos de 7
 * 
 ...
 */
bool multiplos_7_analise(int *primeiro){
    // Números a analisar
    int numeros_para_analise[] = {7,14,21};
